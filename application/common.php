...
if (!function_exists('check_tabbar_active')) {
    /**
     * 检测会员中心导航是否高亮
     */
    function check_tabbar_active($controllername,$url, $classname = 'active')
    {
        return $controllername == $url ? $classname : '';
    }
}
