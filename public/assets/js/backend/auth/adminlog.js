            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'username', title: __('Admins'), formatter: Table.api.formatter.search},
                        {field: 'title', title: __('Title'), operate: 'LIKE %...%', placeholder: __('Fuzzy search')},
                        {field: 'url', title: __('Url'), formatter: Table.api.formatter.url,operate: false},
                        {field: 'ip', title: __('IP'), events: Table.api.events.ip, formatter: Table.api.formatter.search,operate: false},
